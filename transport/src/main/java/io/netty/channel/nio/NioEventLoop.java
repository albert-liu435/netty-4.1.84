 ...
 * 一个 Selector 绑定一个线程 NioEventLoop；
 * 一个 Selector 下有多个 Channel（包装的 Socket）；
 * <p>
 * 同时会对原生的 Selector 进行优化，原生的 selectedKeys 和 publicSelectedKeys 都使用 hashSet 实现，
 * Netty 替换为用数组实现，便于使用遍历方式处理，效率更高。
 * <p>
 * <p>
